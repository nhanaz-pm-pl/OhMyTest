...
| `query.cmd` | Allow querying some other servers information | [] | [] |
| `querys.cmd` | Allow querying some other servers information (Backup method) | [] | [] |
| `kygekpingtps.ping` | Permission to use /ping | [] | [] |
| `kygekpingtps.tps` | Permission to use /tps | [] | [] |
| `bedrockeconomy.command.balance` | Allows users to view their balance | [] | [] |
| `bedrockeconomy.command.pay` | Allows users to pay others with their balance | [] | [] |
| `bedrockeconomy.command.topbalance` | Allows users to view the top balances | [] | [] |
| `bedrockeconomy.command.addbalance` | Allows users to add balance points to others | [] | [] |
| `bedrockeconomy.command.removebalance` | Allows users to remove balance points from others | [] | [] |
| `bedrockeconomy.command.setbalance` | Allows users to change others balance | [] | [] |
| `bedrockeconomy.command.deleteaccount` | Allows users to delete others account data | [] | [] |
| `rulesbook.command` | Permission for /rulesbook | [] | [] |
| `kygeklastposition.cmd` | Permission to use /lastposition command | [] | [] |
| `kygeklastposition.cmd.self` | Permission to use /lastposition command to teleport self | [] | [] |
| `kygeklastposition.cmd.other` | Permission to use /lastposition command to teleport other | [] | [] |
| `kygekeatheal` | Permission to use all KygekEatHeal commands | [] | [] |
| `kygekeatheal.eat` | Permission to use /eat command | [] | [] |
| `kygekeatheal.heal` | Permission to use /heal command | [] | [] |
| `kygekeasygmd.gmdc` | Permission to use /gmdc for self and other | [] | [] |
| `kygekeasygmd.gmds` | Permission to use /gmds for self and other | [] | [] |
| `kygekeasygmd.gmda` | Permission to use /gmda for self and other | [] | [] |
| `kygekeasygmd.gmdsp` | Permission to use /gmdsp for self and other | [] | [] |
