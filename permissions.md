...
| `redskyblockx.command` | With this permission players will recieve access to RedSkyBlockX commands. | [] | [] |
| `redskyblockx.island` | With this permission players will have access to the basic SkyBlock commands. | [] | [] |
| `redskyblockx.admin` | With this permission players will recieve access to all RedSkyBlockX Admin commands. | [] | [] |
| `redskyblockx.bypass` | With this permission players can bypass SkyBlock boundaries. | [] | [] |
| `redskyblockx.createworld` | With this permission players can create a world ready for SkyBlock! | [] | [] |
| `redskyblockx.setworld` | With this permission players can select the world used for SkyBlock. | [] | [] |
| `redskyblockx.reload` | With this permission players can reload the SkyBlock files. | [] | [] |
| `redskyblockx.zone` | With this permission players can manage the custom island zone. | [] | [] |
| `redskyblockx.members` | With this permission players can have unlimited members on their SkyBlock island. | [] | [] |
| `redskyblockx.fly` | With this permission players can fly in the SkyBlock world. | [] | [] |
| `ifa.use` | Permissions allow create, edit, copy items of your choice. | [] | [] |
